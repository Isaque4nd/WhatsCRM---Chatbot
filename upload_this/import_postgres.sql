...
CREATE TABLE "plan" (
  ...
  "createdAt" TIMESTAMP DEFAULT NOW(),
  "qr_account" INTEGER DEFAULT 0,
  "wa_warmer" INTEGER DEFAULT 0,
  "rest_api_qr" INTEGER DEFAULT 0
) ;
...
CREATE TABLE IF NOT EXISTS upload_jobs (
  ...
  delay_min INT NOT NULL DEFAULT 500,
  delay_max INT NOT NULL DEFAULT 1500,
  ordem ENUM('sequencial','embaralhada') NOT NULL DEFAULT 'sequencial',
  intercalar TINYINTEGER NOT NULL DEFAULT 0,
  sent INT NOT NULL DEFAULT 0,
  failed INT NOT NULL DEFAULT 0,
  duplicates INT NOT NULL DEFAULT 0,
  report_csv TEXT NULL,
  report_txt TEXT NULL,
...
CREATE TABLE IF NOT EXISTS upload_job_logs (
  ...
  status ENUM('SENT','FAILED','INVALID','DUPLICATE') NOT NULL,
...
CREATE TABLE "web_private" (
  ...
  "createdAt" TIMESTAMP DEFAULT NOW(),
  "pay_paypal_id" TEXT DEFAULT NULL,
  "pay_paypal_key" TEXT DEFAULT NULL,
  "paypal_active" TEXT DEFAULT NULL,
  "rz_id" TEXT DEFAULT NULL,
  "rz_key" TEXT DEFAULT NULL,
  "rz_active" TEXT DEFAULT NULL,
  "pay_paystack_id" TEXT DEFAULT NULL,
  "pay_paystack_key" TEXT DEFAULT NULL,
  "paystack_active" TEXT DEFAULT NULL
) ;
...
CREATE TABLE "web_public" (
  ...
  "login_header_footer" INTEGER DEFAULT 1,
  "exchange_rate" TEXT DEFAULT NULL,
  "google_client_id" TEXT DEFAULT NULL,
  "google_login_active" INTEGER DEFAULT 1,
...
--
ALTER TABLE "agents"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table "agent_chats"
--
ALTER TABLE "agent_chats"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table "agent_task"
--
ALTER TABLE "agent_task"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=3;
...
--
ALTER TABLE "beta_campaign_logs"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table "beta_chatbot"
--
ALTER TABLE "beta_chatbot"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table "beta_chats"
--
ALTER TABLE "beta_chats"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table "beta_conversation"
--
ALTER TABLE "beta_conversation"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=154;

--
-- AUTO_INCREMENT for table "beta_flows"
--
ALTER TABLE "beta_flows"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table "broadcast"
--
ALTER TABLE "broadcast"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=18;
...
--
ALTER TABLE "chatbot"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=29;
...
--
ALTER TABLE "chat_tags"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=11;
...
--
ALTER TABLE "contact"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=46;
...
--
ALTER TABLE "faq"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table "flow"
--
ALTER TABLE "flow"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table "flow_data"
--
ALTER TABLE "flow_data"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table "flow_session"
--
ALTER TABLE "flow_session"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=87;
...
--
ALTER TABLE "instance"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=57;
...
--
ALTER TABLE "meta_templet_media"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=12;
...
--
ALTER TABLE "page"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table "partners"
--
ALTER TABLE "partners"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=51;
...
--
ALTER TABLE "rooms"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=1319;
...
--
ALTER TABLE "templets"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=10;
...
--
ALTER TABLE "warmer_script"
  MODIFY "id" SERIAL PRIMARY KEY, AUTO_INCREMENT=13;
